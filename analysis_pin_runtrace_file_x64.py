...
class Instruction:
    ...
    def __init__(self, line):
        ...
        if len(parts) >= 4:
            ...
            if len(register_split) == 34:
                self.register = {
                    'rax': register_split[1],
                    'rbx': register_split[3],
                    'rcx': register_split[5],
                    'rdx': register_split[7],
                    'rsi': register_split[9],
                    'rdi': register_split[11],
                    'rbp': register_split[13],
                    'rsp': register_split[15],
                    'r8': register_split[17],
                    'r9': register_split[19],
                    'r10': register_split[21],
                    'r11': register_split[23],
                    'r12': register_split[25],
                    'r13': register_split[27],
                    'r14': register_split[29],
                    'rflags': register_split[31]
                }
...
def merge_serial_blocks(blocks, block_counts):
    ...
    for i in range(len(blocks)):
        ...
        while can_merge:
            ...
            jmp_register_list = ["jmp rax", "jmp rbx", "jmp rcx", "jmp rdx", "jmp rbp", "jmp rsp", "jmp rsi", "jmp rdi", 
                                 "jmp r8", "jmp r9", "jmp r10", "jmp r11", "jmp r12", "jmp r13", "jmp r14", "jmp r15"]
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        ...
        for idx, block in enumerate(blocks):
            ...
            for inst in block.instructions:
                ...
                if "rsp" in operands and "ptr" in operands:
